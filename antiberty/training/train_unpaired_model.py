...
from deeph3.models.AntiBERTy.DataCollatorForGrafting import DataCollatorForCDRGrafting
...
if __name__ == '__main__':
    ...
    data_collator = DataCollatorForCDRGrafting(
        tokenizer=tokenizer,
        mlm=True,
    ...
    dataset = datasets.load_from_disk("/Users/jeffreyruffolo/Local/OAS_db/oas_dataset", keep_in_memory=False)

    # Split train, eval
    # dataset_dict = dataset.train_test_split(test_size=int(1e6), seed=0)
    dataset_dict = dataset.train_test_split(test_size=int(1e4), seed=0)
